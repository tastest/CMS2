...
class MultiparticleReader():
    ...
    def OpenPartonLevel(self):        
        ...
        if os.path.isfile(name):
            logging.info("MadGraph 5 found => multiparticle definitions exported from the file: ")
            logging.info("  "+name)
            self.file = open (name, "r")
        else:
            logging.info("MadGraph 5 NOT found => default multiparticle definitions from the file:")
    ...
    def AddSpecialMultiparticles(self):
        ...
        if not self.cmd_define.main.multiparticles.Find("invisible"):
            ...
            self.npart += 1
            logging.info("Creation of a multiparticle labelled by 'invisible' (related to missing energy).")
        if not self.cmd_define.main.multiparticles.Find("hadronic"):
            ...
            self.npart += 1
            logging.info("Creation of a multiparticle labelled by 'hadronic' (related to jet transverse energy).")
    ...
    def Close(self):
        ...
        logging.info(str(self.npart) + " multiparticles have been successfully exported.")
