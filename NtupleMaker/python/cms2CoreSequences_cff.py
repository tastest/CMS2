...
# jae added
from CMS2.NtupleMaker.sParmMaker_cff               import *

CMS2Reco         = cms.Sequence( cms2JetSequence * metCorSequence * CMS2Btagging * CMS2TrkBtagging * CMS2JPTBtagging * davertexreco)
                 

eventmakers      = cms.Sequence(beamSpotMaker * vertexMaker * vertexMakerWithBS * davertexMaker * eventMaker * cms2InclusiveVertexing * cms2EgammaElectronID * ecalDRFilterMaker * ecalTPFilterMaker * eeBadRecovMaker * sParmMaker) # jae added sParmMaker
