...
process.source = cms.Source("PoolSource",
    ...
    'file:SUSY_gen_fragment_py_GEN_FASTSIM.root'
    ),
)
...
process.prunedUncorrectedCMS2Jets.inputUncorrectedJetCollection = cms.InputTag("ak5CaloJets")
process.pfJetMaker.pfJetsInputTag = cms.InputTag("ak5PFJets")
...
# FOR FASTSIM COMPATIBILITY
process.eventmakers = cms.Sequence(process.beamSpotMaker * process.vertexMaker * process.eventMaker)
process.eidRobustLooseCMS2.reducedBarrelRecHitCollection = cms.InputTag("reducedEcalRecHitsEB")
process.eidRobustLooseCMS2.reducedEndcapRecHitCollection = cms.InputTag("reducedEcalRecHitsEE")
process.eidRobustTightCMS2.reducedBarrelRecHitCollection = cms.InputTag("reducedEcalRecHitsEB")
process.eidRobustTightCMS2.reducedEndcapRecHitCollection = cms.InputTag("reducedEcalRecHitsEE")
process.eidRobustHighEnergyCMS2.reducedBarrelRecHitCollection = cms.InputTag("reducedEcalRecHitsEB")
process.eidRobustHighEnergyCMS2.reducedEndcapRecHitCollection = cms.InputTag("reducedEcalRecHitsEE")
process.eidLooseCMS2.reducedBarrelRecHitCollection = cms.InputTag("reducedEcalRecHitsEB")
process.eidLooseCMS2.reducedEndcapRecHitCollection = cms.InputTag("reducedEcalRecHitsEE")
process.eidTightCMS2.reducedBarrelRecHitCollection = cms.InputTag("reducedEcalRecHitsEB")
process.eidTightCMS2.reducedEndcapRecHitCollection = cms.InputTag("reducedEcalRecHitsEE")

# SParmMaker
process.load('CMS2.NtupleMaker.sParmMaker_cff')
process.othermakers += process.sParmMakerSequence
