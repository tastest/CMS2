...
process.source = cms.Source("PoolSource",
	...
	#'/store/mc/Spring10/TTbar/GEN-SIM-RECO/START3X_V26_S09-v1/0093/003D263E-9D4E-DF11-B728-0017A477042C.root'
	'/store/mc/Spring10/TTbarJets-madgraph/GEN-SIM-RECO/START3X_V26_S09-v1/0006/FE0DD96C-B846-DF11-B5AE-0030487EB003.root'
    ),
)


process.EventSelectionDilepFilt = cms.PSet(
    SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring('pHyp', 'pDilepGen')
                )
        )
...
process.out = cms.OutputModule(
        "PoolOutputModule",
        process.EventSelectionDilepFilt,
...
#process.load('CMS2.NtupleMaker.beamHaloSequence_cff') #in cms2CoreSequences
...
#these are replaced in makeCrabFiles.py
...
#remember, hyp is not just dilep hyp, also trilep, quadlep
process.pHyp              = cms.Path(process.cms2WithEverything * process.hypFilter)
process.pDilepGen         = cms.Path(process.cms2WithEverything * process.dilepGenFilter)
