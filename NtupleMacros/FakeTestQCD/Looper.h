...
const static cuts_t prediction_cuts = (CUT_BIT(CUT_EL_DENOMINATOR));
...
const static cuts_t observation_cuts_even = 
  (CUT_BIT(CUT_EL_NUMERATOR)) | (CUT_BIT(CUT_EVEN));   
...
const static cuts_t prediction_cuts_even = 
  (CUT_BIT(CUT_EL_DENOMINATOR)) | (CUT_BIT(CUT_EVEN));
...
const static cuts_t observation_cuts_odd = 
  (CUT_BIT(CUT_EL_NUMERATOR)) | (CUT_BIT(CUT_ODD));   
...
const static cuts_t prediction_cuts_odd = 
  (CUT_BIT(CUT_EL_DENOMINATOR)) | (CUT_BIT(CUT_ODD));
