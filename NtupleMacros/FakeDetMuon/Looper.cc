...
void Looper::BookHistos ()
{
  ...
  pt_num_mll_  = book1DVarHist(Form("%s_hpt_num_mll",prefix),"p_{T} Numerator",binsPt,"p_{T} [GeV]","p_{T} Loose Muon Numerator",color);
  pt_num_mlt_  = book1DVarHist(Form("%s_hpt_num_mlt",prefix),"p_{T} Numerator",binsPt,"p_{T} [GeV]","p_{T} Tight Muon Numerator",color);
  pt_den_muo_  = book1DVarHist(Form("%s_hpt_den_muo",prefix),"p_{T} Denominator",binsPt,"p_{T} [GeV]","p_{T} Muon Denominator",color);

  eta_num_mll_ = book1DVarHist(Form("%s_heta_num_mll",prefix),"#eta Numerator",binsEta,"#eta","#eta Loose Muon Numerator",color);
  eta_num_mlt_ = book1DVarHist(Form("%s_heta_num_mlt",prefix),"#eta Numerator",binsEta,"#eta","#eta Tight Muon Numerator",color);
  eta_den_muo_ = book1DVarHist(Form("%s_heta_den_muo",prefix),"#eta Denominator",binsEta,"#eta","#eta Muon Denominator",color);

  num_mll_ = book2DVarHist(Form("%s_hnum_mll",prefix),"Numerator",binsEta,binsPt,"#eta","p_{T} [GeV]","Loose Muon Numerator",color);
  num_mlt_ = book2DVarHist(Form("%s_hnum_mlt",prefix),"Numerator",binsEta,binsPt,"#eta","p_{T} [GeV]","Tight Muon Numerator",color);
  den_muo_ = book2DVarHist(Form("%s_hden_muo",prefix),"Denominator",binsEta,binsPt,"#eta","p_{T} [GeV]","Muon Denominator",color);

  pt_num_wo_leading_mll_  = book1DVarHist(Form("%s_hpt_num_wo_leading_mll",prefix),"p_{T} Numerator without leading Jet",binsPt,"p_{T} [GeV]","p_{T} Loose Muon Numerator",color);
  pt_num_wo_leading_mlt_  = book1DVarHist(Form("%s_hpt_num_wo_leading_mlt",prefix),"p_{T} Numerator without leading Jet",binsPt,"p_{T} [GeV]","p_{T} Tight Muon Numerator",color);
  pt_den_wo_leading_muo_  = book1DVarHist(Form("%s_hpt_den_wo_leading_muo",prefix),"p_{T} Denominator without leading Jet",binsPt,"p_{T} [GeV]","p_{T} Muon Denominator",color);

  eta_num_wo_leading_mll_ = book1DVarHist(Form("%s_heta_num_wo_leading_mll",prefix),"#eta Numerator without leading Jet",binsEta,"#eta","#eta Loose Muon Numerator",color);
  eta_num_wo_leading_mlt_ = book1DVarHist(Form("%s_heta_num_wo_leading_mlt",prefix),"#eta Numerator without leading Jet",binsEta,"#eta","#eta Tight Muon Numerator",color);
  eta_den_wo_leading_muo_ = book1DVarHist(Form("%s_heta_den_wo_leading_muo",prefix),"#eta Denominator without leading Jet",binsEta,"#eta","#eta Muon Denominator",color);

  num_wo_leading_mll_ = book2DVarHist(Form("%s_hnum_wo_leading_mll",prefix),"Numerator without leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Loose Muon Numerator",color);
  num_wo_leading_mlt_ = book2DVarHist(Form("%s_hnum_wo_leading_mlt",prefix),"Numerator without leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Tight Muon Numerator",color);
  den_wo_leading_muo_ = book2DVarHist(Form("%s_hden_wo_leading_muo",prefix),"Denominator without leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Muon Denominator",color);

  pt_num_wo_second_leading_mll_  = book1DVarHist(Form("%s_hpt_num_wo_second_leading_mll",prefix),"p_{T} Numerator without second leading Jet",binsPt,"p_{T} [GeV]","p_{T} Loose Muon Numerator",color);
  pt_num_wo_second_leading_mlt_  = book1DVarHist(Form("%s_hpt_num_wo_second_leading_mlt",prefix),"p_{T} Numerator without second leading Jet",binsPt,"p_{T} [GeV]","p_{T} Tight Muon Numerator",color);
  pt_den_wo_second_leading_muo_  = book1DVarHist(Form("%s_hpt_den_wo_second_leading_muo",prefix),"p_{T} Denominator without second leading Jet",binsPt,"p_{T} [GeV]","p_{T} Muon Denominator",color);

  eta_num_wo_second_leading_mll_ = book1DVarHist(Form("%s_heta_num_wo_second_leading_mll",prefix),"#eta Numerator without second leading Jet",binsEta,"#eta","#eta Loose Muon Numerator",color);
  eta_num_wo_second_leading_mlt_ = book1DVarHist(Form("%s_heta_num_wo_second_leading_mlt",prefix),"#eta Numerator without second leading Jet",binsEta,"#eta","#eta Tight Muon Numerator",color);
  eta_den_wo_second_leading_muo_ = book1DVarHist(Form("%s_heta_den_wo_second_leading_muo",prefix),"#eta Denominator without second leading Jet",binsEta,"#eta","#eta Muon Denominator",color);

  num_wo_second_leading_mll_ = book2DVarHist(Form("%s_hnum_wo_second_leading_mll",prefix),"Numerator without second leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Loose Muon Numerator",color);
  num_wo_second_leading_mlt_ = book2DVarHist(Form("%s_hnum_wo_second_leading_mlt",prefix),"Numerator without second leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Tight Muon Numerator",color);
  den_wo_second_leading_muo_ = book2DVarHist(Form("%s_hden_wo_second_leading_muo",prefix),"Denominator without second leading Jet",binsEta,binsPt,"#eta","p_{T} [GeV]","Muon Denominator",color);
	
  muo_n_   = book1DHist(Form("%s_hmuo_n",prefix),"number of muons per event",15,0.,15.,"n_{e}","Events",color);
...
void Looper::FillEventHistos ()
{
  ...
  if ((cuts_passed & cuts_) == cuts_) {
    ...
    //TEMPOUT090219    muo_n_->Fill(cms2.evt_nmus(),weight);
    ...
    for ( unsigned int muon_counter = 0;
      ...
      // general muon histograms
      //TEMPOUT090219      tkIso_uncut_->Fill(cms2.mus_tkIso()[muon_counter],weight);
//       EOverp_uncut_->Fill(cms2.mus_eOverPIn()[muon_counter],weight);
//       HOverE_uncut_->Fill(cms2.mus_hOverE()[muon_counter],weight);

      // fill every muon with pt > 150 GeV into last bin
      ...
      if ( isFakeableMuon(muon_counter)){
        ...
        // this line crashes on muons in inclQCDpt30	  
      // 	cout << "mc id: " << pdg->GetParticle(cms2.mus_mc_id()[muon_counter])->GetName() << " mother: " << pdg->GetParticle(cms2.mus_mc_motherid()[muon_counter])->GetName() << endl;

	pt_den_muo_->Fill(pt);
	if ( useAbsEta ) {
	  eta_den_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  eta_den_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  den_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  den_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	} else {
	  eta_den_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	  den_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	}
	...
	for ( unsigned int jet_counter = 0;
	  ...
	  deltaR_->Fill(dRbetweenVectors(cms2.mus_p4()[muon_counter],cms2.jets_p4()[jet_counter]),weight);
        ...
        //TEMPOUT090219	tkIso_->Fill(cms2.mus_tkIso()[muon_counter],weight);
// 	EOverp_->Fill(cms2.mus_eOverPIn()[muon_counter],weight);
// 	HOverE_->Fill(cms2.mus_hOverE()[muon_counter],weight);
      }

      // loose muons
      if (isNumeratorMuon(muon_counter,1)){ 
	// 1=loose, 2=tight
	if ( !isFakeableMuon(muon_counter) ) cout << "Loose muon: num is fullfilled but den is not!" << endl;
	pt_num_mll_->Fill(pt,weight);
	if ( useAbsEta ) {
	  eta_num_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  eta_num_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  num_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  num_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	} else {
	  eta_num_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	  num_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	}
	...
	if ( pt >= 20. ) {
      ...
      // tight muons
      if ( isNumeratorMuon(muon_counter,2)){ 
	// 1=loose, 2=tight
	if ( !isFakeableMuon(muon_counter) ) cout << "Tight muon: num is fullfilled but den is not!" << endl;
	pt_num_mlt_->Fill(pt,weight);
	if ( useAbsEta ) {
	  eta_num_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  eta_num_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	  num_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  num_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	} else {
	  eta_num_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	  num_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	}
	// hard cut to calculate zero-bin fake rate correctly
	if ( pt >= 20. ) {
	  ++nNumerator_lt_;
      ...
      // exclude leading jet
      if ( dRbetweenVectors(cms2.mus_p4()[muon_counter],cms2.jets_p4()[0]) >= deltaRCut ) {

	if ( isFakeableMuon(muon_counter)){
	  pt_den_wo_leading_muo_->Fill(pt,weight);
	  if ( useAbsEta ) {
	    eta_den_wo_leading_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    eta_den_wo_leading_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    den_wo_leading_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    den_wo_leading_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  } else {
	    eta_den_wo_leading_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	    den_wo_leading_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	  }
	  // hard cut to calculate zero-bin fake rate correctly
	  if ( pt >= 20. ) {
	...
	if (isNumeratorMuon(muon_counter,1)){ 
	  // 1=loose, 2=tight
	  if ( !isFakeableMuon(muon_counter) ) cout << "Loose muon wo leading: num is fullfilled but den is not!" << endl;
	  pt_num_wo_leading_mll_->Fill(pt,weight);
	  if ( useAbsEta ) {
	    eta_num_wo_leading_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    eta_num_wo_leading_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    num_wo_leading_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    num_wo_leading_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  } else {
	    eta_num_wo_leading_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	    num_wo_leading_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	  }
	  // hard cut to calculate zero-bin fake rate correctly
	  if ( pt >= 20. ) {
	...
	if ( isNumeratorMuon(muon_counter,2)) { 
	  // 1=loose, 2=tight
	  if ( !isFakeableMuon(muon_counter) ) cout << "Tight muon wo leading: num is fullfilled but den is not!" << endl;
	  pt_num_wo_leading_mlt_->Fill(pt,weight);
	  if ( useAbsEta ) {
	    eta_num_wo_leading_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    eta_num_wo_leading_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	    num_wo_leading_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    num_wo_leading_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	  } else {
	    eta_num_wo_leading_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	    num_wo_leading_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	  }
	  // hard cut to calculate zero-bin fake rate correctly
	  if ( pt >= 20. ) {
	...
	if ( (dRbetweenVectors(cms2.mus_p4()[muon_counter],cms2.jets_p4()[0]) >= deltaRCut) &&
	     (dRbetweenVectors(cms2.mus_p4()[muon_counter],cms2.jets_p4()[1]) >= deltaRCut) ) {

	  if ( isFakeableMuon(muon_counter)){
	    pt_den_wo_second_leading_muo_->Fill(pt,weight);
	    if ( useAbsEta ) {
	      eta_den_wo_second_leading_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      eta_den_wo_second_leading_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      den_wo_second_leading_muo_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	      den_wo_second_leading_muo_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    } else {
	      eta_den_wo_second_leading_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	      den_wo_second_leading_muo_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	    }
	    // hard cut to calculate zero-bin fake rate correctly
	    if ( pt >= 20. ) {
	  ...
	  if (isNumeratorMuon(muon_counter,1)){ 
	    // 1=loose, 2=tight
	    if ( !isFakeableMuon(muon_counter) ) cout << "Loose muon wo 2nd leading: num is fullfilled but den is not!" << endl;
	    pt_num_wo_second_leading_mll_->Fill(pt,weight);
	    if ( useAbsEta ) {
	      eta_num_wo_second_leading_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      eta_num_wo_second_leading_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      num_wo_second_leading_mll_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	      num_wo_second_leading_mll_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    } else {
	      eta_num_wo_second_leading_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	      num_wo_second_leading_mll_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	    }
	    // hard cut to calculate zero-bin fake rate correctly
	    if ( pt >= 20. ) {
	  ...
	  if ( isNumeratorMuon(muon_counter,2)){ 
	    // 1=loose, 2=tight
	    if ( !isFakeableMuon(muon_counter) ) cout << "Tight muon wo 2nd leading: num is fullfilled but den is not!" << endl;
	    pt_num_wo_second_leading_mlt_->Fill(pt,weight);
	    if ( useAbsEta ) {
	      eta_num_wo_second_leading_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      eta_num_wo_second_leading_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),weight);
	      num_wo_second_leading_mlt_->Fill(TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	      num_wo_second_leading_mlt_->Fill(-TMath::Abs(cms2.mus_p4()[muon_counter].Eta()),pt,weight);
	    } else {
	      eta_num_wo_second_leading_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),weight);
	      num_wo_second_leading_mlt_->Fill(cms2.mus_p4()[muon_counter].Eta(),pt,weight);
	    }
	    // hard cut to calculate zero-bin fake rate correctly
	    if ( pt >= 20. ) {
