...
int MuoFakes ()
{
//  return run<Looper>(muo_fakes_cuts, "MuoFakes", 1 << LOOP_QCDEMenrichedPt20to30 | 1 << LOOP_QCDEMenrichedPt30to80 | 1 << LOOP_QCDEMenrichedPt80to170 | 1 << LOOP_QCDBCtoEPt20to30 | 1 << LOOP_QCDBCtoEPt30to80 | 1 << LOOP_QCDBCtoEPt80to170);
return run<Looper>(muo_fakes_cuts, "MuoFakes", 1 << LOOP_QCDBCtoEPt20to30);
}

int MuoFakesInc ()
{
  return run<Looper>(muo_fakes_cuts, "MuoFakes", 1 << LOOP_QCDpt30);
}

int MuoFakesInclusiveMuPt15 ()
{
