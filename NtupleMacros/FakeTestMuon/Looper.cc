...
//     ret |= (CUT_BIT(CUT_PASS_JETVETO_TRACKJETS));
  ...
  // temporary bools to switch MuMu or EMu case
  bool onlyMuMu = false;
  bool onlyEMu  = true;
  ...
  if(onlyMuMu) {
    ...
    if ((ret & (CUT_BIT(CUT_LT_GOOD) | CUT_BIT(CUT_LT_ISO) | CUT_BIT(CUT_TRUE_LT_MU_FROM_W_WJETS))) == 
        (CUT_BIT(CUT_LT_GOOD) | CUT_BIT(CUT_LT_ISO) | CUT_BIT(CUT_TRUE_LT_MU_FROM_W_WJETS))) {
    ...
    if ((ret & (CUT_BIT(CUT_LL_GOOD) | CUT_BIT(CUT_LL_ISO) | CUT_BIT(CUT_TRUE_LL_MU_FROM_W_WJETS))) == 
        (CUT_BIT(CUT_LL_GOOD) | CUT_BIT(CUT_LL_ISO) | CUT_BIT(CUT_TRUE_LL_MU_FROM_W_WJETS))) {
