{
  ...
  TFile *_file0 = TFile::Open("090211_03/Wjets_Fakerate.root");
  TFile *_file2 = TFile::Open("090212_01/Wjets_Fakerate.root");
  ...
  elept_em->Update();
  TLatex *   lable_ref = new TLatex(0.55,0.75,"Red: enriched");
  lable_ref->SetNDC();
  lable_ref->SetTextSize(0.04);
  lable_ref->SetTextColor(kRed);
  TLatex *   lable_new = new TLatex(0.55,0.7,"Blue: incl. without trigger");
  lable_new->SetNDC();
