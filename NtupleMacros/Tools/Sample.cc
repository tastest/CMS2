...
Sample fWW ()
{
     ...
     std::string sample = prefix + "cms2-V02-00-12/WW_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/WZ_Summer09-MC_31X_V3_7TeV-v1_v2/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/ZZ_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Wenu_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Wmunu_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Wtaunu_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Zee_Summer09-MC_31X_V3_7TeV_TrackingParticles-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Zmumu_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/Ztautau_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/TTBar_Summer09-MC_31X_V3_7TeV-v1/merge*root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/QCD_Pt30_Summer09-MC_31X_V3_7TeV-v1/merge*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/InclusiveMu5_Pt30_Summer09-MC_31X_V3_7TeV-v1_2xv41m/merged*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/QCD_EMEnriched_Pt80to170_Summer09-MC_31X_V3_7TeV-v1/merged*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/PhotonJet_Pt30to50_Summer09-MC_31X_V3_7TeV-v1/merged*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/PhotonJet_Pt50to80_Summer09-MC_31X_V3_7TeV-v1/merged*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/PhotonJet_Pt80to120_Summer09-MC_31X_V3_7TeV-v1/merged*.root";
     c->Add(sample.c_str());
...
{
     TChain *c = new TChain("Events");
     std::string sample = prefix + "cms2-V02-00-12/PhotonJet_Pt120to170_Summer09-MC_31X_V3_7TeV-v1/merged*.root";
     c->Add(sample.c_str());
