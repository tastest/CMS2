...
bool  passThisHLTTrigger( char* hltname ){
  ...
  if( !foundTrigger ){
    cout << "ERROR! Did not find trigger matching pattern " << hltname << endl;
    return false;
  }
  ...
  cout << "ERROR! shouldn't get to " << __FILE__ << " " << __LINE__ << endl;
  return false;
...
bool select (bool isData)
{
  ...
  if( passThisHLTTrigger( "HLT_Photon20_CaloIdVL_IsoL_v"  ))              return true;
  if( passThisHLTTrigger( "HLT_Photon30_CaloIdVL_IsoL_v"  ))              return true;
  if( passThisHLTTrigger( "HLT_Photon50_CaloIdVL_IsoL_v"  ))              return true;
  if( passThisHLTTrigger( "HLT_Photon75_CaloIdVL_IsoL_v"  ))              return true;      
  if( passThisHLTTrigger( "HLT_Photon90_CaloIdVL_IsoL_v"  ))              return true;
  if( passThisHLTTrigger( "HLT_Photon135_v"               ))              return true;
  if( passThisHLTTrigger( "HLT_Photon150_v"               ))              return true;
  if( passThisHLTTrigger( "HLT_Photon160_v"               ))              return true;
  
  if( passThisHLTTrigger( "HLT_Photon22_R9Id90_HE10_Iso40_EBOnly_v" ))    return true;
  if( passThisHLTTrigger( "HLT_Photon36_R9Id90_HE10_Iso40_EBOnly_v" ))    return true;
  if( passThisHLTTrigger( "HLT_Photon50_R9Id90_HE10_Iso40_EBOnly_v" ))    return true;
  if( passThisHLTTrigger( "HLT_Photon75_R9Id90_HE10_Iso40_EBOnly_v" ))    return true;
  if( passThisHLTTrigger( "HLT_Photon90_R9Id90_HE10_Iso40_EBOnly_v" ))    return true;
  
  return false;
}

void ntupleFilter_PhotonTrigger(const std::string &infile, const std::string &outfile, bool printPass=false, bool isData = true, std::string runlist = "")  
{
    // set good run list
