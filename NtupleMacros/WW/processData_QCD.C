...
if (runWjets) {
  ...
  fWjets->Add("/data/tmp/cms2-V01-02-06/InclusiveMuPt15/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/InclusiveMu5Pt50/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_EMenriched_Pt20to30/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_EMenriched_Pt30to80/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_EMenriched_Pt80to170/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_BCtoE_Pt20to30/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_BCtoE_Pt30to80/merged_ntuple*.root");
  fWjets->Add("/data/tmp/cms2-V01-02-06/QCD_BCtoE_Pt80to170/merged_ntuple*.root");
}
