...
void Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	if (tree->GetAlias("evt_scale1fb") != 0) {
		...
		evt_scale1fb_branch->SetAddress(&evt_scale1fb);
	}
	...
	if (tree->GetAlias("trk_elsdr") != 0) {
		...
		trk_elsdr_branch->SetAddress(&trk_elsdr);
	}
	...
	if (tree->GetAlias("trk_musdr") != 0) {
		...
		trk_musdr_branch->SetAddress(&trk_musdr);
	}
	...
	if (tree->GetAlias("trk_elsidx") != 0) {
		...
		trk_elsidx_branch->SetAddress(&trk_elsidx);
	}
	...
	if (tree->GetAlias("trk_musidx") != 0) {
		...
		trk_musidx_branch->SetAddress(&trk_musidx);
	}
