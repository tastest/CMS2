...
EffH1F::EffH1F(std::string name, std::string title, Int_t nbinsx, Double_t xlow, Double_t xup )
{
  numer = new TH1F( Form("%s_%s", name.c_str(), "numer"), Form("%s_%s", name.c_str(), "numer"), nbinsx, xlow, xup );
  denom = new TH1F( Form("%s_%s", name.c_str(), "denom"), Form("%s_%s", name.c_str(), "denom"), nbinsx, xlow, xup );
  eff = new TH1F( Form("%s_%s", name.c_str(), "eff"), Form("%s_%s", name.c_str(), "eff"), nbinsx, xlow, xup );
