...
void plotResultsW(TString det, TString fileStamp, TString refFileStamp, float & luminorm)
{
	...
	//plotDataRefOverlayStack(datah1, refh1, "ele_selected_pfmetdphi", "#Delta#Phi (Electron, pfMET)", fileStamp, det, 1);
	//plotDataRefOverlayStack(datah1, refh1, "ele_selected_tcmetdphi", "#Delta#Phi (Electron, tcMET)", fileStamp, det, 1);
