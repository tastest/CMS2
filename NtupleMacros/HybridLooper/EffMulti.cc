...
{
	e1_pt_ = new EffH1F(source + "_" + var + "_pt_" + det, var, 100, 0, 200);
        e1_eta_ = new EffH1F(source + "_" + var + "_eta_" + det, var, 24, -3, 3);
        e1_phi_ = new EffH1F(source + "_" + var + "_phi_" + det, var, 72, -3.14159, 3.14159);
}
