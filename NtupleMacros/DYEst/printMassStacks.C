...
void printMassStacks(TString met)
{
	...
	gROOT->cd();
        ...
        THStack *st_tmp = anaHist.getMassStack(f, "0j", "mm");
        ...
        lg_tmp->Draw();
        saveCanvas(c0j_mm, "st_mass_0j_" + met + "_mm");
        ...
        lg_tmp->Draw();
        saveCanvas(c1j_mm, "st_mass_1j_" + met + "_mm");
        ...
        lg_tmp->Draw();
        saveCanvas(c2j_mm, "st_mass_2j_" + met + "_mm");
        ...
        lg_tmp->Draw();
        saveCanvas(c0j_ee, "st_mass_0j_" + met + "_ee");
        ...
        lg_tmp->Draw();
        saveCanvas(c1j_ee, "st_mass_1j_" + met + "_ee");
        ...
        lg_tmp->Draw();
        saveCanvas(c2j_ee, "st_mass_2j_" + met + "_ee");
        ...
        lg_tmp->Draw();
        saveCanvas(c0j_em, "st_mass_0j_" + met + "_em");
        ...
        lg_tmp->Draw();
        saveCanvas(c1j_em, "st_mass_1j_" + met + "_em");
        ...
        lg_tmp->Draw();
        saveCanvas(c2j_em, "st_mass_2j_" + met + "_em");
