...
protected:
  ...
  TH1F *pt_num_wo_leading_ell_;
  TH1F *pt_num_wo_leading_elt_;
  TH1F *pt_den_wo_leading_ele_;

  TH1F *eta_num_wo_leading_ell_;
  TH1F *eta_num_wo_leading_elt_;
  TH1F *eta_den_wo_leading_ele_;

  TH2F *num_wo_leading_ell_;
  TH2F *num_wo_leading_elt_;
  TH2F *den_wo_leading_ele_;

  TH1F *pt_num_wo_second_leading_ell_;
  TH1F *pt_num_wo_second_leading_elt_;
  TH1F *pt_den_wo_second_leading_ele_;

  TH1F *eta_num_wo_second_leading_ell_;
  TH1F *eta_num_wo_second_leading_elt_;
  TH1F *eta_den_wo_second_leading_ele_;

  TH2F *num_wo_second_leading_ell_;
  TH2F *num_wo_second_leading_elt_;
  TH2F *den_wo_second_leading_ele_;
