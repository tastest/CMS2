...
runLooper_electron(){
  ...
  Chain->Draw("els_p4.eta() >> singleElectron", ww_baseline_2);
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_eta_ww.eps");
  ...
  Chain->Draw("els_valid_pixelhits >> singleElectron",ww_baseline_2 && forward);
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_valid_pixelhits_ww.eps");
  ...
  Chain->Draw("els_layer1_det  >> singleElectron", ww_baseline_2 && forward &&"(els_valid_pixelhits==2||els_valid_pixelhits==1)");
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_layer1_detid_ww.eps");

  TH1F hist_singleElectron("singleElectron", "singleElectron; Layer of the first valid pixel hit (Barrel)", 10,0,5);
  Chain->Draw("els_layer1_layer  >> singleElectron", ww_baseline_2 && forward &&"(els_valid_pixelhits==2||els_valid_pixelhits==1) && els_layer1_det==1");
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_layer1_layer_barrel_ww.eps");
  ...
  Chain->Draw("els_layer1_charge  >> singleElectron", ww_baseline_2 && forward && "(els_valid_pixelhits==2||els_valid_pixelhits==1) &&els_layer1_det==2");
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_layer1_charge_disk_ww.eps");
  ...
  Chain->Draw("abs(els_p4.eta()):els_layer1_charge  >> Electron",ww_baseline_2 && forward && "(els_valid_pixelhits==2||els_valid_pixelhits==1) &&els_layer1_det==2", "box");
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_layer1_chargeVsEta_disk_ww.eps");
  
  TH1F hist_singleElectron("singleElectron", "singleElectron; Number of expected inner layers", 16,0,8);
  Chain->Draw("els_n_inner_layers >> singleElectron", ww_baseline_2 );
  c1->SaveAs("~/sample_plots/conversions/3_1_x/singleElectron_ele_ninner_ww.eps");
...
runLooper_gamma(){
  ...
  TH1F hist_singleGamma("singleGamma", "singleGamma; Number of expected inner layers", 16,0,8);
