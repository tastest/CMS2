...
void doAll_ossusy_looper_gmsb(bool skipFWLite = true)
{
  // Load various tools  
  ...
  gSystem->CompileMacro("ossusy_looper_gmsb.C","++k", "libossusy_looper_gmsb");

  ossusy_looper_gmsb* looper = new ossusy_looper_gmsb();
...
//                      "SingleTop_tChannel"); 
  ...
  if (runML1) {
    pickSkimIfExists(chML1, 
                     "/tas/cms2/PhysicsProcess_PYTHIA6_SUSY_GMSM_SC_ML01_7TeV_v0/V03-04-13-01-gmsb/merged_ntuple*root",
                     "SUSY_ML1");
  }
          ...
          for (int zvetoIdx = 0; zvetoIdx < 1; ++zvetoIdx)
            {
              ...
              ossusy_looper_gmsb::JetTypeEnum  jetType(jetTypeIdx);
              ossusy_looper_gmsb::MetTypeEnum  metType(metTypeIdx);
              ossusy_looper_gmsb::ZVetoEnum    zveto(zvetoIdx);
