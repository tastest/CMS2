{
  ...
  if( sample.Contains("wjets") ) {
    ...
    if(doSS) {
      TFile *_file0 = TFile::Open("../v1_4_flippers/Ttbar_SS_FlipPredicted.root");
      TFile *_file2 = TFile::Open("../v1_6_egun_flippers/Ttbar_SS_FlipPredicted.root");
    }
    else {
