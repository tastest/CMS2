...
// 6u
ch1->Draw("abs(eta)>>num6u","num&&l16u>1&&abs(id)==13&&tcmet<20");
ch1->Draw("abs(eta)>>fo6u",      "l16u>1&&abs(id)==13&&tcmet<20");
// 10u
ch1->Draw("abs(eta)>>num10u","num&&l110u>1&&abs(id)==13&&tcmet<20");
ch1->Draw("abs(eta)>>fo10u",      "l110u>1&&abs(id)==13&&tcmet<20");
// 15u
ch2->Draw("abs(eta)>>num15u","num&&hlt15u>1&&abs(id)==13&&tcmet<20");
ch2->Draw("abs(eta)>>fo15u",      "hlt15u>1&&abs(id)==13&&tcmet<20");
// 30u
ch2->Draw("abs(eta)>>num30u","num&&hlt30u>1&&abs(id)==13&&tcmet<20");
ch2->Draw("abs(eta)>>fo30u",      "hlt30u>1&&abs(id)==13&&tcmet<20");
// 50u
ch2->Draw("abs(eta)>>num50u","num&&hlt50u>1&&abs(id)==13&&tcmet<20");
ch2->Draw("abs(eta)>>fo50u",      "hlt50u>1&&abs(id)==13&&tcmet<20");
//
ch2->Draw( "abs(eta)>>num15uMu5", "num&&hlt15u>1&&mu5==2&&abs(id)==13&&tcmet<20");
ch2->Draw( "abs(eta)>>fo15uMu5", "hlt15u>1&&mu5==2&&abs(id)==13&&tcmet<20");
//
ch2->Draw( "abs(eta)>>num15uMu9", "num&&hlt15u>1&&mu9==2&&abs(id)==13&&tcmet<20");
ch2->Draw( "abs(eta)>>fo15uMu9", "hlt15u>1&&mu9==2&&abs(id)==13&&tcmet<20");
