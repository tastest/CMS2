...
// 6u
ch1->Draw("abs(eta)>>num6u","num&&l16u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v16u","v1&&l16u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v26u","v2&&l16u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v36u","v3&&l16u>1&&abs(id)==11&&tcmet<20");
// 10u
ch1->Draw("abs(eta)>>num10u","num&&l110u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v110u","v1&&l110u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v210u","v2&&l110u>1&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v310u","v3&&l110u>1&&abs(id)==11&&tcmet<20");
// 15u
ch2->Draw("abs(eta)>>num15u","num&&hlt15u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v115u","v1&&hlt15u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v215u","v2&&hlt15u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v315u","v3&&hlt15u>1&&abs(id)==11&&tcmet<20");
// 30u
ch2->Draw("abs(eta)>>num30u","num&&hlt30u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v130u","v1&&hlt30u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v230u","v2&&hlt30u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v330u","v3&&hlt30u>1&&abs(id)==11&&tcmet<20");
// 50u
ch2->Draw("abs(eta)>>num50u","num&&hlt50u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v150u","v1&&hlt50u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v250u","v2&&hlt50u>1&&abs(id)==11&&tcmet<20");
ch2->Draw("abs(eta)>>v350u","v3&&hlt50u>1&&abs(id)==11&&tcmet<20");
...
TCanvas * ctemp = new TCanvas();
ch1->Draw("abs(eta)>>num15uph10","num&&hlt15u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v115uph10","v1&&hlt15u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v215uph10","v2&&hlt15u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v315uph10","v3&&hlt15u>1&&ph10==2&&abs(id)==11&&tcmet<20");
delete ctemp;
...
TCanvas * ctemp = new TCanvas();
ch1->Draw("abs(eta)>>num10uph10","num&&l110u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v110uph10","v1&&l110u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v210uph10","v2&&l110u>1&&ph10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v310uph10","v3&&l110u>1&&ph10==2&&abs(id)==11&&tcmet<20");
delete ctemp;
...
TCanvas * ctemp = new TCanvas();
ch1->Draw("abs(eta)>>num10uel10","num&&l110u>1&&el10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v110uel10","v1&&l110u>1&&el10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v210uel10","v2&&l110u>1&&el10==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v310uel10","v3&&l110u>1&&el10==2&&abs(id)==11&&tcmet<20");
delete ctemp;
...
TCanvas * ctemp = new TCanvas();
ch1->Draw("abs(eta)>>num10ueg5","num&&l110u>1&&eg5==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v110ueg5","v1&&l110u>1&&eg5==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v210ueg5","v2&&l110u>1&&eg5==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v310ueg5","v3&&l110u>1&&eg5==2&&abs(id)==11&&tcmet<20");
delete ctemp;
...
TCanvas * ctemp = new TCanvas();
ch1->Draw("abs(eta)>>num10ueg8","num&&l110u>1&&eg8==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v110ueg8","v1&&l110u>1&&eg8==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v210ueg8","v2&&l110u>1&&eg8==2&&abs(id)==11&&tcmet<20");
ch1->Draw("abs(eta)>>v310ueg8","v3&&l110u>1&&eg8==2&&abs(id)==11&&tcmet<20");
delete ctemp;
