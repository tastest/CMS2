...
////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////
          ...
          // Electrons
          pair<int, float> pair_ele8_v2                                           = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_v2"                                         );
          pair<int, float> pair_ele8_CaloIdL_TrkIdVL_v2                           = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_TrkIdVL_v2"                         );
          pair<int, float> pair_ele8_CaloIdL_CaloIsoVL_Jet40_v2                   = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_CaloIsoVL_Jet40_v2"                 );
          pair<int, float> pair_ele8_CaloIdL_CaloIsoVL_v2                         = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_CaloIsoVL_v2"                       );
          pair<int, float> pair_ele17_CaloIdL_CaloIsoVL_v2                        = TriggerMatch( els_p4().at(iLep), "HLT_Ele17_CaloIdL_CaloIsoVL_v2"                      );  
          //pair<int, float> pair_photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v2  = TriggerMatch( els_p4().at(iLep), "HLT_Photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v2");
  
          pair<int, float> pair_ele8_v1                                           = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_v1"                                         );
          pair<int, float> pair_ele8_CaloIdL_TrkIdVL_v1                           = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_TrkIdVL_v1"                         );
          pair<int, float> pair_ele8_CaloIdL_CaloIsoVL_Jet40_v1                   = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_CaloIsoVL_Jet40_v1"                 );
          pair<int, float> pair_ele8_CaloIdL_CaloIsoVL_v1                         = TriggerMatch( els_p4().at(iLep), "HLT_Ele8_CaloIdL_CaloIsoVL_v1"                       );
          pair<int, float> pair_ele17_CaloIdL_CaloIsoVL_v1                        = TriggerMatch( els_p4().at(iLep), "HLT_Ele17_CaloIdL_CaloIsoVL_v1"                      );  
          //pair<int, float> pair_photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1  = TriggerMatch( els_p4().at(iLep), "HLT_Photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1");
          ...
          ele8_v1_                                              = pair_ele8_v1.first;
          ele8_CaloIdL_TrkIdVL_v1_                              = pair_ele8_CaloIdL_TrkIdVL_v1.first; 
          ele8_CaloIdL_CaloIsoVL_Jet40_v1_                      = pair_ele8_CaloIdL_CaloIsoVL_Jet40_v1.first;
          ele8_CaloIdL_CaloIsoVL_v1_                            = pair_ele8_CaloIdL_CaloIsoVL_v1.first;
          ele17_CaloIdL_CaloIsoVL_v1_                           = pair_ele17_CaloIdL_CaloIsoVL_v1.first; 
          //photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1_     = pair_photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1.first;
          
          dr_ele8_v1_                                           = pair_ele8_v1.second;
          dr_ele8_CaloIdL_TrkIdVL_v1_                           = pair_ele8_CaloIdL_TrkIdVL_v1.second;
          dr_ele8_CaloIdL_CaloIsoVL_Jet40_v1_                   = pair_ele8_CaloIdL_CaloIsoVL_Jet40_v1.second;
          dr_ele8_CaloIdL_CaloIsoVL_v1_                         = pair_ele8_CaloIdL_CaloIsoVL_v1.second;
          dr_ele17_CaloIdL_CaloIsoVL_v1_                        = pair_ele17_CaloIdL_CaloIsoVL_v1.second;
          //dr_photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1_  = pair_photon20_CaloIdVT_IsoT_Ele8_CaloIdL_CaloIsoVL_v1.second; 
...
////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////
          ...
          // Muons
          pair<int, float> pair_mu3_v3       = TriggerMatch( mus_p4().at(iLep), "HLT_Mu3_v3"       );
          pair<int, float> pair_mu5_v3       = TriggerMatch( mus_p4().at(iLep), "HLT_Mu5_v3"       );
          pair<int, float> pair_mu8_v1       = TriggerMatch( mus_p4().at(iLep), "HLT_Mu8_v1"       );
          pair<int, float> pair_mu12_v1      = TriggerMatch( mus_p4().at(iLep), "HLT_Mu12_v1"      );
          pair<int, float> pair_mu15_v2      = TriggerMatch( mus_p4().at(iLep), "HLT_Mu15_v2"      );
          pair<int, float> pair_mu20_v1      = TriggerMatch( mus_p4().at(iLep), "HLT_Mu20_v1"      );
          pair<int, float> pair_mu24_v1      = TriggerMatch( mus_p4().at(iLep), "HLT_Mu24_v1"      );
          pair<int, float> pair_mu30_v1      = TriggerMatch( mus_p4().at(iLep), "HLT_Mu30_v1"      );
          pair<int, float> pair_mu8_Jet40_v3 = TriggerMatch( mus_p4().at(iLep), "HLT_Mu8_Jet40_v3" );
