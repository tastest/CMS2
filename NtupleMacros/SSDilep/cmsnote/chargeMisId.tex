...
The method used to estimate the Charge Mis-Identification contribution to selected 
data sample is presented in details in [xx]. The goal of the method is to predict, 
in a data driven way, the charge mis-identification of the electrons. This is accomplished
...
identified $OS$ electrons. The details of the procedure can be found [xx]. 
