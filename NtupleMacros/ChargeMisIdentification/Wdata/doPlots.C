{
  ...
  cout << "els_eta_reco->Integral()=" << els_eta_reco->Integral() << endl; 
  cout << "els_eta_sim->Integral()=" << els_eta_sim->Integral() << endl; 
  cout << "eff = " << eff << endl;
  ...
  //forward_num = els_eta_reco->Integral(1,els_eta_reco->FindBin(-1*f_b_eta_divider)) + els_eta_reco->Integral(els_eta_reco->FindBin(f_b_eta_divider),els_eta_reco->GetNbinsX()+1);
  //forward_den = els_eta_sim->Integral(1,els_eta_sim->FindBin(-1*f_b_eta_divider)) + els_eta_sim->Integral(els_eta_sim->FindBin(f_b_eta_divider),els_eta_sim->GetNbinsX()+1);
  forward_num = els_eta_reco->Integral(1,els_eta_reco->FindBin(-1*f_b_eta_divider)-1) + els_eta_reco->Integral(els_eta_reco->FindBin(f_b_eta_divider)+1,els_eta_reco->GetNbinsX()+1);
  forward_den = els_eta_sim->Integral(1,els_eta_sim->FindBin(-1*f_b_eta_divider)-1) + els_eta_sim->Integral(els_eta_sim->FindBin(f_b_eta_divider)+1,els_eta_sim->GetNbinsX()+1);
  forward_eff = forward_num / forward_den * 100;
  cout << " barrel_num=" << barrel_num << endl;
  cout << " barrel_den=" << barrel_den << endl;
  cout << " barrel_eff=" << barrel_eff << endl;
  cout << " forward_num=" << forward_num << endl;
  cout << " forward_den=" << forward_den << endl;
  cout << " forward_eff=" << forward_eff << endl;
  ...
  cout << " ------------------------------------------------------------ " << endl;
  cout << "els_pt_recosim_incorCharge->Integral() = " << els_pt_recosim_incorCharge->Integral() << endl; 
  cout << "els_pt_recosim->Integral() = " << els_pt_recosim->Integral() << endl; 
  ...
  forward_num = els_eta_recosim_incorCharge->Integral(0,els_eta_recosim_incorCharge->FindBin(-1*f_b_eta_divider)-1) + els_eta_recosim_incorCharge->Integral(els_eta_recosim_incorCharge->FindBin(f_b_eta_divider)+1,els_eta_recosim_incorCharge->GetNbinsX()+1);
  forward_den = els_eta_recosim->Integral(0,els_eta_recosim->FindBin(-1*f_b_eta_divider)-1) + els_eta_recosim->Integral(els_eta_recosim->FindBin(f_b_eta_divider)+1,els_eta_recosim->GetNbinsX()+1);
  ...
  cout << " barrel_num=" << barrel_num << endl;
  cout << " barrel_den=" << barrel_den << endl;
  cout << " barrel_ineff=" << barrel_ineff << endl;
  cout << " forward_num=" << forward_num << endl;
  cout << " forward_den=" << forward_den << endl;
  cout << " forward_ineff=" << forward_ineff << endl;
...
///*
  ...
  std::cout << " total reco efficiency                  : " <<  Form("%3.3f", eff) << " %" << std::endl;
  std::cout << " barrel reco efficiency                 : " <<  Form("%3.3f", barrel_eff) << " %" << std::endl;
  std::cout << " forward reco efficiency                : " <<  Form("%3.3f", forward_eff) << " %" << std::endl;

  std::cout << " ---------------------* misidentification rate *-----------------------  " << std::endl;
  std::cout << " total charge misidentification rate    : " <<  barrel_num + forward_num << "/" << barrel_den+forward_den << "="
							    <<  (barrel_num + forward_num) / (barrel_den+forward_den) << "="
                                                            <<  Form("%3.3f", ineff) << " %" << std::endl;
  std::cout << " barrel charge misidentification rate   : " <<  barrel_num << "/" << barrel_den << "="
                                                            <<  Form("%3.3f", barrel_ineff) <<  " %" << std::endl;
  std::cout << " forward charge misidentification rate  : " <<  forward_num << "/" << forward_den << "="
                                                            <<  Form("%3.3f", forward_ineff) << " %" << std::endl;
  std::cout << " ----------------------------------------------------------------------  " << std::endl;
//*/
