...
/*
    ...
    DrawAll("pfmet",prefix+"_pfmet",os_preselection,luminosity,40,0.,1000.,0, babyVector);
*/
...
//    DrawAll("jetmass",prefix+"_exotica_z_highptdijets",cut_z_highptdijets,luminosity,40,0.,2000.,0, babyVector);
    ...
    DrawAll("jetmass",prefix+"_lowpu_exotica_z_dijets","nvtx<3" + cut_z_dijets,luminosity,40,0.,2000.,0, babyVector);
    DrawAll("jetmass",prefix+"_highpu_exotica_z_dijets","nvtx>=3" + cut_z_dijets,luminosity,40,0.,2000.,0, babyVector);
