...
//   Iso03_MinBias_mc->SetLineWidth(3);
  ...
  leg->Draw();
  if(!jura){
    TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EE_skimdata_mc_int",iso_opt.Data(),"_V03-00-23.gif" );
    TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EE_skimdata_mc_int",iso_opt.Data(),"_V03-00-23.eps" );
  }
  else{
    TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EE_skimdata_mc_int",iso_opt.Data(),"_V03-00-23_jura.gif" );
    TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EE_skimdata_mc_int",iso_opt.Data(),"_V03-00-23_jura.eps" ); 
