...
runLooper_Iso_MinBias_skimdata_mc_EB( TString iso_opt = "ran_ecalIso03_mu",  bool jura = false){
  ...
  MinBias_mc->Add("MCCorrZ_skimmednTuple.root"); 
  MinBias_skimdata->Add("DataCorrZ_skimmednTuple.root"); 
  
  
  TString draw_opt_MinBias_skimdata = Form("%s%s", iso_opt.Data(), ">> _MinBias_skimdata(50,-0.5,2)");
  MinBias_skimdata->Draw(draw_opt_MinBias_skimdata.Data(), baseline_minbias_EB);
...
//   Iso03_MinBias_skimdata->SetLineWidth(3);
  ...
  MinBias_mc->Draw(draw_opt_MinBias_mc.Data(), baseline_minbias_EB, "sames");
...
//   Iso03_MinBias_mc->SetLineWidth(3);
 ...
 //  // leg->Draw();
     if(!jura){
     TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_CorrZ",iso_opt.Data(),"_V03-00-23.gif" );
     TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_",iso_opt.Data(),"_V03-00-23.eps" );
   }
   else{
     TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_CorrZ",iso_opt.Data(),"_V03-00-23_jura.gif" );
     TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_CorrZ",iso_opt.Data(),"__V03-00-23_jura.eps" ); 
...
runLooper_Iso_MinBias_skimdata_mc_EB_int( TString iso_opt = "ran_ecalIso03_mu",  bool jura = false){
...
//   Iso03_MinBias_mc->SetLineWidth(3);
  ...
  leg->Draw();
  if(!jura){
    TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_intCorrZ",iso_opt.Data(),"_V03-00-23.gif" );
    TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_intCorrZ",iso_opt.Data(),"_V03-00-23.eps" );
  }
  else{
    TString save_opt1= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_intCorrZ",iso_opt.Data(),"_V03-00-23_jura.gif" );
    TString save_opt2= Form("%s%s%s","../../../plots/900GeV/EB_skimdata_mc_intCorrZ",iso_opt.Data(),"_V03-00-23_jura.eps" ); 
...
draw(TString iso_opt_1 = "ran_trkIso03_mu"){
  runLooper_Iso_MinBias_skimdata_mc_EB(iso_opt_1);
  runLooper_Iso_MinBias_skimdata_mc_EB_int(iso_opt_1);
...
runLooper_Iso_MinBias_skimdata_mc_EB_int( TString iso_opt = "ran_trkIso03_mu",  bool jura = false){
...
//   Iso03_MinBias_mc->SetLineWidth(3);
 ...
 //  // leg->Draw();
//   if(!jura){
//     TString save_opt1= Form("%s%s%s","plots/900GeV/EB_skimdata_mc_",iso_opt.Data(),"_V03-00-23.gif" );
//     TString save_opt2= Form("%s%s%s","plots/900GeV/EB_skimdata_mc_",iso_opt.Data(),"_V03-00-23.eps" );
//   }
//   else{
//     TString save_opt1= Form("%s%s%s","plots/900GeV/EB_skimdata_mc_",iso_opt.Data(),"_V03-00-23_jura.gif" );
//     TString save_opt2= Form("%s%s%s","plots/900GeV/EB_skimdata_mc_",iso_opt.Data(),"__V03-00-23_jura.eps" ); 
