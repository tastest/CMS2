...
//   static const unsigned int LOOSEDIL_OS_ONEWEIGHT = (1<<10) + (1<<13) + (1<<14);
  ...
  int ScanChain ( std::string fName, std::string prefix, float kFactor=1.0, int prescale=1, bool oldjets=true, unsigned int cutsMask=31);
  int ScanChain ( TChain* chain, std::string prefix, float kFactor=1.0, int prescale=1, bool oldjets=true, unsigned int cutsMask=31);
  int ScanChain ( std::vector<ProcDSChain>& pds, std::string prefix, float kFactor=1.0, int prescale=1, bool oldjets=true, unsigned int cutsMask=31);
