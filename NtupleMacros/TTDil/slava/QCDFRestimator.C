...
int QCDFRestimator::ScanChainWJets ( TChain* chain, char * prefix,
...
int QCDFRestimator::ScanChainQCD ( TChain* chain, char * prefix, float kFactor, int prescale,
...
void QCDFRestimator::bookHistos(char *sample) {
