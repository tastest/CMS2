...
int doAll() {
  ...
  if (runWW) 
    ProcessSample("ww", "data/VVJetsTo4L_TuneD6T_7TeV-madgraph-tauola_Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/V03-06-17/diLepPt2020/merged*.root", utilFile,  -1, Lumi, 4.5*0.919, 963356*(682015./963356.), "", false, true);
  
  if (runttbar) 
    ProcessSample("ttbar", "data/TTJets_TuneZ2_7TeV-madgraph-tauola_Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v3/V03-06-18/diLepPt2020/*.root", -1 ,Lumi, 157.5, -1); 
  ...
  if  (runWjets) {
    ...
    // ProcessSample("wjets","data/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_Fall10-START38_V12-v1/V03-06-18/diLepPt1020Skim/skimmed_ntuple.root", utilFile,  -1, Lumi, 31314.0, -1); // di-lepton 20/10
  }
  if (runDYmm)
    ProcessSample("dymm", "data/DYToMuMu_M-20_CT10_TuneZ2_7TeV-powheg-pythia_Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/V03-06-17/diLepPt2020/*.root", -1 ,Lumi, 1666, -1); 
  
  if (runDYee) 
    ProcessSample("dyee", "data/DYToEE_M-20_CT10_TuneZ2_7TeV-powheg-pythia_Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/V03-06-17/diLepPt2020/*.root", ch, -1 ,Lumi, 1666, -1); 
  ...
  if (runZZ) 
    ProcessSample("zz","data/ZZtoAnything_TuneZ2_7TeV-pythia6-tauola_Fall10-E7TeV_ProbDist_2010Data_BX156_START38_V12-v1/V03-06-17/diLepPt2020/*.root", utilFile,  -1 ,Lumi, 5.9, -1); 
