...
int doAll() {
  ...
  if (runDYtt) 
    ProcessSample("Ztt", "data/DYToTauTau_M-20_TuneZ2_7TeV-pythia6-tauola_Fall10-START38_V12-v1/V03-06-14/*.root", utilFile,   -1 ,Lumi, 1666, -1); 
  ...
  if (runWgamma)
    ProcessSample("Vg", "data/PhotonVJets_7TeV-madgraph_Fall10-START38_V12-v1/CMS2_V03-06-17/*.root", utilFile,   -1 ,Lumi, 165.0, -1); 
