...
class ParticleReader():
    ...
    def OpenPartonLevel(self):
        ...
        if os.path.isfile(name):
            logging.info("MadGraph 5 found => particle definitions exported from the file :")
            logging.info("  "+name)
            self.file = open (name, "r")
        else:
            logging.info("MadGraph 5 NOT found => default particle names from the file:")
    ...
    def Close(self):
        ...
        logging.info(str(self.npart) + " particles have been successfully exported.")
