...
class CmdOpen(CmdBase):
    ...
    def do(self,args):
        ...
        filename=""
        if HTMLReportWriter.CheckStructure(args[0]):
            filename="index.html"
        elif LATEXReportWriter.CheckStructure(args[0]):
            if os.path.isfile(self.main.currentdir + "/" + args[0] + "/main.pdf"):
                filename="main.pdf"
            else:
                filename="main.tex"
        else:
        ...
        name = "file://"+os.path.normpath(self.main.currentdir + "/" + args[0] + "/" + filename)
