...
TET = ObservableBase( name        = 'TET',
                      ...
                      plot_xmax   = 1000.,
                      plot_unitX  = 'GeV',
                      code_parton = 'PHYSICS->EventTET(event.mc())',
                      code_hadron = 'PHYSICS->EventTET(event.mc())',
                      code_reco   = 'PHYSICS->EventTET(event.rec())',
                      cut_event     = True,
                      cut_candidate = True,
                      tex           = 'E_{T}'
...
MET = ObservableBase( name        = 'MET',
                      ...
                      plot_xmax   = 1000.,
                      plot_unitX  = 'GeV',
                      code_parton = 'PHYSICS->EventMET(event.mc())',
                      code_hadron = 'PHYSICS->EventMET(event.mc())',
                      code_reco   = 'PHYSICS->EventMET(event.rec())',
                      cut_event     = True,
                      cut_candidate = True,
                      tex           = '#slash{E}_{T}'
                    )
...
THT = ObservableBase( name        = 'THT',
                      ...
                      plot_xmax   = 1000.,
                      plot_unitX  = 'GeV',
                      code_parton = 'PHYSICS->EventTHT(event.mc())',
                      code_hadron = 'PHYSICS->EventTHT(event.mc())',
                      code_reco   = 'PHYSICS->EventTHT(event.rec())',
                      cut_event     = True,
                      cut_candidate = True,
                      tex           = 'H_{T}'
                    )
...
MHT = ObservableBase( name        = 'MHT',
                      ...
                      plot_xmax   = 1000.,
                      plot_unitX  = 'GeV',
                      code_parton = 'PHYSICS->EventMHT(event.mc())',
                      code_hadron = 'PHYSICS->EventMHT(event.mc())',
                      code_reco   = 'PHYSICS->EventMHT(event.rec())',
                      cut_event     = True,
                      cut_candidate = True,
                      tex           = '#slash{H}_{T}'
                    )
