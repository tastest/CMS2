...
class ExpertMode:
    ...
    def CreateDirectory(self):
        ...
        logging.info("Please enter a folder for creating an empty SampleAnyzer job")
    ...
    def Copy(self):
        ...
        jobber = JobWriter(self.main.ma5dir,\
                           self.path,False,self.main.libZIP)
    ...
    def GiveAdvice(self):
        ...
        logging.info(" 1. Entering the directory '"+self.path+"'\n")
        logging.info(" 2. Setting the environment variables by loading setup.sh or setup.csh according to your SHELL\n")
        logging.info(" 3. Editing Analysis '"+self.dir+".h' and '"+self.dir+".cpp' files\n")
        logging.info(" 4. Compiling with the command 'make'\n")
        logging.info(" 5. Writing a list of datasets\n")
        logging.info(" 6. Launching SampleAnalyzer with the list of datasets\n")
