...
#include "DataFormat/MCSampleFormat.h"
#include "DataFormat/RecSampleFormat.h"
...
class SampleFormat
{
 ...
 private:
  ...
  ULong_t           nevents_;   /// Number of events in the file
  MCSampleFormat  * mc_;
 ...
 public :
  ...
  void InitializeMC()
  {
    if (mc_!=0) 
    {
      WARNING << "MC part of the SampleFormat is already initialized" << std::endl;
    }
  ...
  void InitializeRec()
  {
    if (rec_!=0) 
    {
      WARNING << "REC part of the SampleFormat is already initialized" << std::endl;
    }
