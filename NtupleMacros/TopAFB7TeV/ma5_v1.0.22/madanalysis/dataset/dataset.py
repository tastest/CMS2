...
class Dataset:
    ...
    def __init__(self,name):
        ...
        self.backshade         = 0
        self.filenames         = []
        self.measured_xsection = 0.0
        self.measured_xerror   = 0.0
        self.measured_n        = 0L
        self.title             = name
    ...
    def Display(self):
        ...
        logging.info("   ******************************************" )
        msg = "   Cross section = "
        if self.measured_xsection==0 or self.measured_xerror!=0:
            msg+="("
        msg += Layout.DisplayXsection(self.measured_xsection,self.measured_xerror)
        if self.measured_xsection==0 or self.measured_xerror!=0:
            msg+=")"
        msg += " pb"
        logging.info(msg)
        logging.info("   Total number of events = " + str(self.measured_n)) 
        logging.info("   ******************************************" )
