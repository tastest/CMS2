...
void CompareHists(TString histname, int rebin = 5, int drawnorm =1, TString FName1 = "../TopAFB_NLO/results/hist_usePtGt2020_hypDisamb_usepfMET_usepfJets_useOS_vetoHypMassLt12_requireBTag_sortJetCandidatesbyPt_generalLeptonVeto_createBabyNtuples_applylepIDCuts_applylepIsoCuts_vetoZmass_veto2Jets_vetoMET.root", TString FName2 = "../TopAFBa/results/hist_usePtGt2020_hypDisamb_usepfMET_usepfJets_useOS_vetoHypMassLt12_requireBTag_sortJetCandidatesbyPt_generalLeptonVeto_createBabyNtuples_applylepIDCuts_applylepIsoCuts_vetoZmass_veto2Jets_vetoMET.root", TString FName3 = "../TopAFBb/results/hist_usePtGt2020_hypDisamb_usepfMET_usepfJets_useOS_vetoHypMassLt12_requireBTag_sortJetCandidatesbyPt_generalLeptonVeto_createBabyNtuples_applylepIDCuts_applylepIsoCuts_vetoZmass_veto2Jets_vetoMET.root"){
  setTDRStyle();

  std::cout << "Opening " << FName1.Data() << "\n";
  TFile *f_1         = TFile::Open(FName1.Data());  
  histo1 = AddUpAllMC(f_1,Form("%s_%ij_all",histname.Data(),2));  
    
  std::cout << "Opening " << FName2.Data() << "\n";
  TFile *f_2         = TFile::Open(FName2.Data());  
  histo2 = AddUpAllMC(f_2,Form("%s_%ij_all",histname.Data(),2));    

  std::cout << "Opening " << FName3.Data() << "\n";
  TFile *f_3         = TFile::Open(FName3.Data());
  histo3 = AddUpAllMC(f_3,Form("%s_%ij_all",histname.Data(),2));
  
  datahisto = (TH1F*)f_2->Get(Form("data_%s_%ij_all", histname.Data(),2));
...
/*
  KS1 = histo1->KolmogorovTest(datahisto,"UO");
  KS2 = histo2->KolmogorovTest(datahisto,"UO");
...
*/
  ...
  datahisto->GetYaxis()->SetTitleOffset(1.7);	
  ...
  leg->AddEntry(histo1, "MC@NLO","l");
  leg->AddEntry(histo2, "madgraph","l");
